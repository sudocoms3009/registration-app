...
public class PrerequisiteListViewAdapter extends BaseAdapter {

    Context context;
    ArrayList<Prerequisite> arraylist;
    int count = 0;

    public PrerequisiteListViewAdapter(Context context, ArrayList<Prerequisite> arraylist) {
